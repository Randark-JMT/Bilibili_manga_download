...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QRect(10, 10, 431, 91))
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.textEdit_3)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.textEdit_2)
        ...
        self.textBrowser.setGeometry(QRect(15, 161, 741, 431))
        font = QFont()
