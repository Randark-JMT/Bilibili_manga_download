...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setMinimumSize(QSize(140, 70))
        ...
        self.gridLayout.addWidget(self.pushButton_6, 3, 3, 1, 4)

        self.pushButton_2 = QPushButton(self.centralwidget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setMinimumSize(QSize(140, 70))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"B\u7ad9\u626b\u7801\u767b\u5f55", None))
